import { l as client } from "./singletons-8cb78471.js";
/**
 * @license
...
var wa$1 = x$1("Opera"), y = x$1("Trident") || x$1("MSIE"), xa = x$1("Edge"), ya$1 = xa || y, za = x$1("Gecko") && !(-1 != sa().toLowerCase().indexOf("webkit") && !x$1("Edge")) && !(x$1("Trident") || x$1("MSIE")) && !x$1("Edge"), Aa = -1 != sa().toLowerCase().indexOf("webkit") && !x$1("Edge");
function Ba() {
  var a = l.document;
      ...
      a: {
        ...
        if (!(3 > r) && (3 != r || ya$1 || this.g && (this.h.h || this.g.fa() || hc(this.g)))) {
          ...
          if (this.i) {
            ...
            this.P ? (lc(this, r, h), ya$1 && this.i && 3 == r && (Eb(this.S, this.T, "tick", this.hb), this.T.start())) : (E(this.j, this.m, h, null), kc(this, h));
            4 == r && P$1(this);
    ...
    if (0 != c.G && (c.g == a || qc(c.h, a))) {
      if (!a.J && qc(c.h, a) && 3 == c.G) {
        ...
        if (Array.isArray(d) && 3 == d.length) {
          ...
          R(c, 11);
      } else if ((a.J || c.g == a) && rc(c), !pa$1(b2))
